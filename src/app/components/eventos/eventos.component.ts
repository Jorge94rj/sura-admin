...
export class EventosComponent implements OnInit {
  ...
  public collectionRelatedName = "itinerarios";
  public relatedField = "eventoId";
  ...
  editEvento(index) {
    ...
    const formContent = {
      formItems: formItems, imageFieldAvailable: true,
      imageFieldOptional: true
    } as IFormContent;
        ...
        if (result) {
          ...
          this._adminService.deleteItemWithImage(this.storageName, itemSelectedData.imagenId,
            this.collectionName, itemSelectedId).then(
              () => {
                this.deleteItinerarios(itemSelectedId);
